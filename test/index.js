...
tape.test('single sum', function(t) {
	...
	t.true( isNaN(powerSums([null,'a',undefined], 1)), 'invalid samples should return NaN as sum')

	t.end()
})


tape.test('multiple sums', function(t) {
	...
	t.true( isNaN(powerSums([null,'a',undefined], Array(2))[1]), 'invalid samples should return NaN array')
